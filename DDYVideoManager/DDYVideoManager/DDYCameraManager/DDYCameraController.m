...
- (void)viewDidLoad {
    ...
    [_cameraView setFilterBlock:^(NSString *filterName) {[weakSelf handleFilter:filterName];}];
...
#pragma mark 选择滤镜
- (void)handleFilter:(NSString *)filterName {
    [self.cameraManager setFilterName:filterName];
}
